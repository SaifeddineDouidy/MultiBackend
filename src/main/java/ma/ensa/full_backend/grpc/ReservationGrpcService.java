...
//            }
//
//            // Create the reservation and assign rooms
...
//            }
//
//            // Fetch and update the reservation
//            List<Long> newChambreIds = request.getReservation().getChambreIdsList();
//            Reservation updatedReservation = new Reservation();
//            updatedReservation.setId(request.getReservation().getId());
...
//
//            Reservation savedReservation = reservationService.updateReservation(updatedReservation.getId(), updatedReservation, newChambreIds);
//
//            ma.ensa.full_backend.stubs.Reservation grpcReservation = ma.ensa.full_backend.stubs.Reservation.newBuilder()
//                    .setId(savedReservation.getId())
